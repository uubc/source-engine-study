...
void MsgFunc_KillCam(bf_read& msg)
{
	...
	if (newMode != CSGameRules()->m_nKillCamMode)
	{
	...
	CSGameRules()->m_nKillCamTarget1 = msg.ReadByte();
	CSGameRules()->m_nKillCamTarget2 = msg.ReadByte();
}

void CCSGameWorld::Init()
{
	BaseClass::Init();
...
//-----------------------------------------------------------------------------
int	CCSGameWorld::KeyInput(int down, ButtonCode_t keynum, const char* pszCurrentBinding)
{
...
float CCSGameWorld::GetViewModelFOV(void)
{
	return 74.0f;
}

int CCSGameWorld::GetDeathMessageStartHeight(void)
{
	return m_pViewport->GetDeathMessageStartHeight();
}

void CCSGameWorld::FireGameEvent(IGameEvent* event)
{
...
void CCSGameWorld::PostRenderVGui()
{
...
bool CCSGameWorld::ShouldDrawViewModel(void)
{
...
bool CCSGameWorld::CanRecordDemo(char* errorMsg, int length) const
{
...
void CCSGameWorld::SetServerName(wchar_t* name)
{
	V_wcsncpy(m_pServerName, name, sizeof(m_pServerName));
}

void CCSGameWorld::SetMapName(wchar_t* name)
{
