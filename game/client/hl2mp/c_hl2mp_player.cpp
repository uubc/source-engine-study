...
void C_HL2MP_Player::TraceAttack( const ITakeDamageInfo&info, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
...
{
	return (C_HL2MP_Player*)EntityList()->GetLocalPlayer();
}
