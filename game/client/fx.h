...
void FX_MuzzleEffect( const Vector &origin, const QAngle &angles, float scale, IClientEntity* hEntity, unsigned char *pFlashColor = NULL, bool bOneFrame = false );
void FX_MuzzleEffectAttached( float scale, IClientEntity* hEntity, int attachmentIndex, unsigned char *pFlashColor = NULL, bool bOneFrame = false  );
void FX_StriderMuzzleEffect( const Vector &origin, const QAngle &angles, float scale, CBaseHandle hEntity, unsigned char *pFlashColor = NULL );
void FX_GunshipMuzzleEffect( const Vector &origin, const QAngle &angles, float scale, CBaseHandle hEntity, unsigned char *pFlashColor = NULL );
