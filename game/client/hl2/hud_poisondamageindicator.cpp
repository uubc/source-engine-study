...
void CHudPoisonDamageIndicator::OnThink()
{
	...
	{
		SetVisible(true);
		g_pGameRules->GetViewportAnimationController()->StartAnimationSequence( "PoisonDamageTaken" );
	}
	else
	{
		g_pGameRules->GetViewportAnimationController()->StartAnimationSequence( "PoisonDamageCured" );
	}
}
