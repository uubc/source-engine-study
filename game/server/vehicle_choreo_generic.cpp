...
// Purpose: 
//-----------------------------------------------------------------------------
void CPropVehicleChoreoGeneric::Use( IServerEntity *pActivator, IServerEntity *pCaller, USE_TYPE useType, float value )
{
...
bool CPropVehicleChoreoGeneric::ParseViewParams( const char *pScriptName )
{
	...
	IVPhysicsKeyParser *pParse = EntityList()->PhysGetCollision()->VPhysicsKeyParserCreate( (char *)pFile );
