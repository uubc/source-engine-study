...
public:
	...
	virtual bool ClientCommand( CBasePlayer *player, const CCommand &args, int nClientIndex);
...
{
	return static_cast<CBasePlayer *>(EntityList()->CreateEntityByName( "cs_bot", ed ) );
}
