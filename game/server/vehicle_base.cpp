...
// Purpose: 
//-----------------------------------------------------------------------------
void CPropVehicleDriveable::Use( IServerEntity *pActivator, IServerEntity *pCaller, USE_TYPE useType, float value )
{
...
void CFourWheelServerVehicle::NPC_SetDriver( CNPC_VehicleDriver *pDriver )
{
	...
	else
	{
		...
		GetFourWheelVehicle()->GetEngineObject()->SetOwnerEntity( NULL );
