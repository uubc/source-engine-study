...
#if 0
	UTIL_TraceHull( start, start + vel * gpGlobals->frametime, GetEngineObject()->OBBMins(), GetEngineObject()->OBBMaxs(), CONTENTS_HITBOX|CONTENTS_MONSTER|CONTENTS_SOLID, &filter, &tr );
#else
