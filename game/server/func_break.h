...
// IBreakableWithPropData
	...
	void			SetPropDataBlocksLOS( bool bBlocksLOS ) { GetEngineObject()->SetBlocksLOS( bBlocksLOS ); }
	void			SetPropDataIsAIWalkable( bool bBlocksLOS ) { GetEngineObject()->SetAIWalkable( bBlocksLOS ); }
