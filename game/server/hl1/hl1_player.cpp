...
void CHL1_Player::StartCommand(CUserCmd* cmd)
{
...
//-----------------------------------------------------------------------------
void CHL1_Player::SetupMove(CUserCmd* ucmd, IMoveHelper* pHelper, CMoveData* move)
{
...
//-----------------------------------------------------------------------------
void CHL1_Player::FinishMove(CUserCmd* ucmd, CMoveData* move)
{
